...
import { resolveAreaPath, resolveChartBadge, resolveLinePath, resolveSeriesPoints } from './chartUtils'
...
const areaPath = computed(() => resolveAreaPath(points.value))
...
<template>
  <div class="viz-shell">
    ...
    <div class="viz-body">
      ...
      <p v-else class="viz-empty">표시할 영역 차트 데이터가 없어요.</p>
    </div>
  </div>
</template>
...
.viz-area { fill:rgba(24, 74, 140, 0.16); stroke:none; }
