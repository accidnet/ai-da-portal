...
import DatasetCatalogPanel from '@/features/data-source/components/DatasetCatalogPanel.vue'
import SourceDataPanel from '@/features/data-source/components/SourceDataPanel.vue'
import type {
  DataSourceItem,
